...
$(document).ready(function() {  
    ...
    function cargarListaTeclas() {
        ...
        Object.entries(KeyboardList).forEach(([keyCode, keyName]) => {
            ...
            if (keyName) {
                const $button = $('<button>', { class: "bg-blue-500 hover:bg-blue-700 text-white font-bold py-5 px-4 rounded-lg m-1", text: keyName });
...
function agregarBotonConX(texto) {
    const $button = $('<button>', { class: "bg-blue-500 hover:bg-blue-700 text-white font-bold py-5 px-4 rounded-lg m-1", text: texto });
